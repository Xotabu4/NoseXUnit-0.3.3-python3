...
class TestCase(unittest.TestCase):
    ...
    def get(self, entry):
        ...
        # Check if exists
        if entry not in self.i_properties:
            # Not available, raise
    ...
    def assertNotNone(self, value):
        ...
        self.assertNotEqual(None, value)
    ...
    def assertSet(self, expected, found):
        ...
        for exp in expected: self.assertEqual(expected.count(exp), found.count(exp))
    ...
    def assertRaiseOutput(self, excClass, output, callableObj, *args, **kwargs):
        ...
        except excClass as e: self.assertEqual(output, str(e))
